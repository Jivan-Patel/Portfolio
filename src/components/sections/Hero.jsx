                    ...
                    {[
                        ...
                        return (
                            <a
                                ...
                                className={`relative group p-3 sm:p-4 rounded-full bg-secondary/70 text-main/75 transition-all duration-300 hover:-translate-y-2 hover:bg-secondary hover:${item.color} shadow-lg hover:shadow-[0_0_15px_currentColor] border border-main/15 hover:border-currentColor/50 flex items-center justify-center`}
                            >

        ...
        <section ref={heroRef} id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10 pt-20">
                <div ref={contentRef} className="space-y-10">
                    ...
                    <h2 className="text-3xl md:text-5xl font-bold text-main/70">
                        {heroData.role}
                    </h2>
                ...
                <div
                    ref={linksBlockRef}
                    className="mt-16 space-y-12 pb-10"
                >
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6">
                        {[
                            ...
                            { icon: SiSololearn, url: "https://www.sololearn.com/en/profile/35598716", name: "SoloLearn", color: "hover:text-[#1195aa]" },
                        ].map((item, index) => {
                            ...
                            return (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className={`relative group p-3 sm:p-4 rounded-full bg-secondary/70 text-main/75 transition-all duration-300 hover:-translate-y-2 hover:bg-secondary ${item.color} shadow-lg hover:shadow-[0_0_15px_currentColor] border border-main/15 hover:border-currentColor/50 flex items-center justify-center`}
                                >
                                    ...
                                    <span className="absolute -top-12 left-1/2 -translate-x-1/2 bg-primary text-main text-xs font-semibold py-1.5 px-3 rounded shadow-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none border border-main/15">
                                        {item.name}
                                        {/* Tooltip Arrow */}
                                        <span className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-primary rotate-45 border-b border-r border-main/15"></span>
                                    </span>
                                </a>
                            );
                        })}
